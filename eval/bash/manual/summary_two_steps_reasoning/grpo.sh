#!/bin/bash
# === Manual two-step eval (generate + summarize, grade reasoning trace): grpo ===
...
uv run python scripts/stats.py outputs/stage2-qwen3-4b-grpo-imoproofbench-summary-reasoning-graded.jsonl
