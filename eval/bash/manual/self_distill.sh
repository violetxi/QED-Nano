...
#   --output-path outputs/stage2-qwen3-4b-self-distill-imoproofbench.jsonl \
#   --overwrite \
#   --n 4
...
#   --data-path outputs/stage2-qwen3-4b-self-distill-imoproofbench.jsonl \
#   --output-path outputs/stage2-qwen3-4b-self-distill-imoproofbench-graded.jsonl

# 2c: IMOProofBench stats
uv run python scripts/stats.py outputs/stage2-qwen3-4b-self-distill-imoproofbench-graded.jsonl

# # 2d: ProofBench generation
# uv run python scripts/run.py \
#   --model-config vllm/vllm-violetxi-stage2-qwen3-4b-self-distill \
#   --data-path lm-provers/ProofBench \
#   --output-path outputs/stage2-qwen3-4b-self-distill-proofbench.jsonl \
#   --overwrite \
#   --n 4
...
# uv run python scripts/eval.py \
#   --model-config  openai/gpt-5-nano \
#   --data-path outputs/stage2-qwen3-4b-self-distill-proofbench.jsonl \
#   --output-path outputs/stage2-qwen3-4b-self-distill-proofbench-graded.jsonl \
#   --proofbench

# 2f: ProofBench stats
uv run python scripts/stats.py outputs/stage2-qwen3-4b-self-distill-proofbench-graded.jsonl
