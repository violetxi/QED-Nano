...
#   --data-path outputs/stage1_proof-qwen3-4b-grpo-imoproofbench-summary.jsonl \
#   --output-path outputs/stage1_proof-qwen3-4b-grpo-imoproofbench-summary-graded.jsonl

# 2b-alt: Grade reasoning trace for IMOProofBench
uv run python scripts/eval.py \
  --model-config google/gemini-3.1-flash-medium \
  --data-path outputs/stage1_proof-qwen3-4b-grpo-imoproofbench-summary.jsonl \
  --output-path outputs/stage1_proof-qwen3-4b-grpo-imoproofbench-summary-reasoning-graded.jsonl \
  --submission-column reasoning_trace

# 2c-alt: IMOProofBench reasoning-trace stats
uv run python scripts/stats.py outputs/stage1_proof-qwen3-4b-grpo-imoproofbench-summary-reasoning-graded.jsonl
...
#   --model-config google/gemini-3.1-flash-medium \
#   --data-path outputs/stage1_proof-qwen3-4b-grpo-proofbench-summary.jsonl \
#   --output-path outputs/stage1_proof-qwen3-4b-grpo-proofbench-summary-reasoning-graded.jsonl \
#   --submission-column reasoning_trace \
#   --proofbench
