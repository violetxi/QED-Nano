...
python -m vllm.entrypoints.openai.api_server \
  --model violetxi/stage1_proof_pr_delta \
  --host 0.0.0.0 \
  --port 8000 \
  --dtype bfloat16 \
  --max-model-len 49152 \
...
#   --data-path outputs/stage1_proof-qwen3-4b-dense-process-imoproofbench-summary.jsonl \
#   --output-path outputs/stage1_proof-qwen3-4b-dense-process-imoproofbench-summary-graded.jsonl

# # 2b-alt: Grade reasoning trace for IMOProofBench
# uv run python scripts/eval.py \
#   --model-config google/gemini-3.1-flash-medium \
#   --data-path outputs/stage1_proof-qwen3-4b-dense-process-imoproofbench-summary.jsonl \
#   --output-path outputs/stage1_proof-qwen3-4b-dense-process-imoproofbench-summary-reasoning-graded.jsonl \
#   --submission-column reasoning_trace

# 2c-alt: IMOProofBench reasoning-trace stats
uv run python scripts/stats.py outputs/stage1_proof-qwen3-4b-dense-process-imoproofbench-summary-reasoning-graded.jsonl
...
# uv run python scripts/eval.py \
#   --model-config google/gemini-3.1-flash-medium \
#   --data-path outputs/stage1_proof-qwen3-4b-dense-process-proofbench-summary.jsonl \
#   --output-path outputs/stage1_proof-qwen3-4b-dense-process-proofbench-summary-graded.jsonl \
#   --proofbench

# # 2e-alt: Grade reasoning trace for ProofBench
# uv run python scripts/eval.py \
#   --model-config google/gemini-3.1-flash-medium \
#   --data-path outputs/stage1_proof-qwen3-4b-dense-process-proofbench-summary.jsonl \
#   --output-path outputs/stage1_proof-qwen3-4b-dense-process-proofbench-summary-reasoning-graded.jsonl \
#   --submission-column reasoning_trace \
#   --proofbench

# 2f-alt: ProofBench reasoning-trace stats
# uv run python scripts/stats.py outputs/stage1_proof-qwen3-4b-dense-process-proofbench-summary-reasoning-graded.jsonl
